...
echo -e "\e [0;40;31m This tool is updated periodically so you have to reinstall this tool periodically so that more tools are available. 

chek
https://github.com/darkspider1/ToolKing
...
then
    cd $HOME
    rm -rf ToolKing
    git clone https://github.com/darkspider1/ToolKing
